...
N -1440 -40 -1310 -40 { lab=Vota_bias}
N -1270 -40 -1260 -40 { lab=GND}
N -1310 -70 -1310 -40 { lab=Vota_bias}
N -1310 -70 -1270 -70 { lab=Vota_bias}
...
N -1270 -350 -1270 -70 { lab=Vota_bias}
...
model="pnp_05v5_W3p40L3p40 m=35"
spiceprefix=X
}
...
C {design/opamp/opamp_realcomp.sym} -740 -460 1 1 {name=x2}
C {devices/lab_pin.sym} -1440 -40 2 1 {name=l2 lab=Vota_bias}
C {devices/lab_pin.sym} -640 -430 2 0 {name=l18 lab=Vota_bias}
C {devices/ammeter.sym} -1270 -440 0 0 {name=Vmbias current=1.0057e-05}
C {code_shown.sym} 70 90 0 0 {name=globalvalue only_toplevel=false value="
...
device=resistor
m=1}
C {res.sym} 0 -300 0 0 {name=R4
value=10k
footprint=1206
device=resistor
m=1}
C {code.sym} -1650 -350 0 0 {name=commands only_toplevel=false value="
