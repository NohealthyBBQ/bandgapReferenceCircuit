...
N 0 -600 20 -600 {
lab=VDD}
N -260 -420 -250 -420 { lab=GND}
N -260 -390 -250 -420 { lab=GND}
N -260 -580 -260 -450 {
lab=vgate}
N -260 -390 -260 -10 {
lab=GND}
C {devices/code.sym} 700 -380 0 0 {name=TT_MODELS
only_toplevel=true
...
model="pnp_05v5_W3p40L3p40 m=31"
spiceprefix=X
}
...
spiceprefix=X
mult=1}
C {devices/vsource.sym} 490 -490 0 0 {name=V1 net_name=true 
*value="'VDD' pwl 0us 0 1us 'VDD'"
value=1.8}
C {devices/vdd.sym} 490 -520 0 0 {name=l9 lab=VDD}
C {devices/gnd.sym} 490 -460 0 0 {name=l22 lab=GND}
C {devices/vsource.sym} 470 -190 0 0 {name=V2 net_name=true value="0 pulse(0V 1.8V 10us 0us 0us 5us)"}
C {devices/gnd.sym} 470 -160 0 0 {name=l16 lab=GND}
C {devices/lab_pin.sym} 470 -220 0 0 {name=l23 lab=porst}
C {sky130_fd_pr/nfet_01v8_lvt.sym} -280 -420 0 0 {name=M10
L='2'
W='1'
nf=1
mult=34
...
C {devices/lab_pin.sym} -300 -420 0 0 {name=l26 lab=porst}
C {devices/vdd.sym} 60 -670 0 0 {name=l7 lab=VDD}
C {design/opamp/opamp_realcomp2.sym} -740 -460 1 1 {name=x1}
C {devices/code_shown.sym} -1620 120 0 0 {name=s2 
only_toplevel=true 
spice_ignore=false
