...
N -90 -300 -90 -10 {
lab=GND}
N 280 -70 280 -40 { lab=Vota_bias2}
N 280 -70 320 -70 { lab=Vota_bias2}
N 320 -670 320 -600 { lab=VDD}
N 320 -350 320 -70 { lab=Vota_bias2}
N 320 -540 320 -470 {
lab=#net7}
N 320 -410 320 -350 {
lab=Vota_bias2}
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 1000 -470 0 0 {name=M8
L=4
W=4
nf=1
mult=20
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 1040 -40 0 1 {name=M4
L=2
W=8
nf=1
mult=8
...
spiceprefix=X
mult=1}
C {devices/code_shown.sym} -2010 -680 0 0 {name=NGSPICE1
only_toplevel=true
spice_ignore=false
value="
.option savecurrents
...
.endc
" }
C {lab_wire.sym} 500 -400 0 0 {name=l12 sig_type=std_logic lab=Vbg}
C {sky130_fd_pr/nfet_01v8_lvt.sym} 300 -40 0 0 {name=M5
L=2
W=4
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 300 -570 0 0 {name=M6
L=2
W=1
nf=1
mult=40
...
C {devices/ammeter.sym} 320 -440 0 0 {name=Vmbias2 current=1.0057e-05}
C {design/opamp/opamp_realcomp.sym} 620 -420 0 0 {name=x1}
C {devices/lab_pin.sym} 280 -70 2 1 {name=l17 lab=Vota_bias2}
C {devices/lab_pin.sym} 590 -520 2 1 {name=l19 lab=Vota_bias2}
C {sky130_fd_pr/nfet_01v8_lvt.sym} 1040 -130 0 1 {name=M9
L=2
W=8
nf=1
mult=8
...
C {sky130_fd_pr/res_high_po.sym} 840 -100 0 0 {name=R5
W=2
L=255
model=res_high_po
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_high_po.sym} 660 -100 0 0 {name=R6
W=10
L=570
model=res_xhigh_po
spiceprefix=X
